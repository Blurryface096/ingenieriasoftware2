...
from apps.home.views import home,crear_juego, entrar_juego,trivia_juego,resultadostrivia, puntuaciones
...
urlpatterns = [
    ...
    path('resultadostrivia/<int:score>/', resultadostrivia, name='resultadostrivia'),
